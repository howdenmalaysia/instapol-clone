...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command(EGHLSettlement::class)->dailyAt('09:55')->dailyAt('16:15');
        ...
        $schedule->command(InsurerSettlement::class)->dailyAt('09:51')->dailyAt('16:05');
        ...
        $schedule->command(HowdenSettlement::class)->dailyAt('09:53')->dailyAt('16:10');
