...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command(EGHLSettlement::class)->dailyAt('09:50')->dailyAt('16:15');
        ...
        $schedule->command(InsurerSettlement::class)->dailyAt('09:45')->dailyAt('16:05');
        ...
        $schedule->command(HowdenSettlement::class)->dailyAt('09:40')->dailyAt('16:10');
