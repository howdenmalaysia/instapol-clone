        ...
        $data = new APIData([
            ...
            'vehicle' => new Vehicle([
                ...
                'extra_attribute' => (object) [
                    ...
                    'body_type_code' => $motor->vehicle->body_type_code ?? '',
                    'body_type_description' => $motor->vehicle->body_type_description ?? '',
                    'cover_type' => $motor->vehicle->cover_type ?? '',
                    'liberty_model_code' => $motor->vehicle->liberty_model_code ?? '',
                    'vehicle_type_code' => $motor->vehicle->vehicle_type_code ?? '',
                ]
            ]),
