    ...
    public function getQuote(Request $request, $quote_type)
    {
        ...
        $data = new APIData([
            ...
            'vehicle' => new VehicleData([
                ...
                'year_make' => $request->motor->vehicle->manufacture_year ?? '',
                'engine_no' => $request->motor->vehicle->engine_number ?? $request->motor->vehicle->extra_attribute->engine_number ?? '',
                'chassis_no' => $request->motor->vehicle->chassis_number ?? $request->motor->vehicle->extra_attribute->chassis_number ?? '',
