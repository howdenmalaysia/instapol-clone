...
class HowdenSettlementMail extends Mailable
{
    ...
    {
        $mail = $this->subject((app()->environment('local', 'development') ? '[Dev] ' : '') .  "[instaPol-Motor] " . ($this->is_monthly ? 'Monthly' : '') . " Settlement Details for {$this->data['start_date']} to {$this->data['end_date']}")
