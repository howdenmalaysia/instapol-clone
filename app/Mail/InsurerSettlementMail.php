...
class InsurerSettlementMail extends Mailable
{
    ...
    {
        $mail = $this->subject((app()->environment('local', 'development') ? '[Dev] ' : '') .  "[instaPol-Motor] Settlement Details for {$this->data['insurer_name']} {$this->data['start_date']} to {$this->data['end_date']}")
