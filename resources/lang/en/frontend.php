        ...
        'compare_page' => [
            ...
            'occupation' => [
                ...
                'private' => [
                    ...
                    'ADJUSTER',
                    'ADMINISTRATOR',
                    'ADVERTISING/DESIGNING SERVICES',
                    'ADVISOR',
                    'ADVOCATOR',
                    'AGENT',
                    'AGRICULTURIST',
                    ...
                    'ARMY',
                    'AROMATHERAPIST',
                    'ART/HANDICRAFT/ANTIQUE DEALER',
                    'ARTIST',
                    'ASSEMBLE OF VARIABLE RESISTORS',
                    'ASSISTANT',
                    'ASSOCIATE',
                    'ATHLETE',
                    'ATTENDANT',
                    ...
                    'ADMITTING CLERK',
                    'AGENT (INSURANCE)',
                    'AIRCON SERVICING TECHNICIAN',
                    'AIRFREIGHT CO-ORDINATOR',
                    'ANAETHESIAN',
                    ...
                    'CLAIMS ASSISTANT',
                    'CLEANING SERVICES-GENERAL WORK',
                    'CLEARENCE CREW',
                    'CLERICAL OFFICER',
                    'CLINIC ASSISTANT',
                    'COMPUTER CLERK',
                    ...
                    'FLORIST',
                    'FOOD INDUSTRIES',
                    'FOREIGN EX-CHANGE DEALER',
                    'FOREMAN',
                    'FORWARDING/TRANSPORTATION CO',
                    'FRAMEWORK/STRUCTURE INDUSTRIES',
                    'FRANCHISE',
                    'FRUITS/VEGETABLE SUPPLIER',
                    ...
                    'HAIRDRESSER',
                    'HAIRDRESSING/BARBER-GENERAL WO',
                    'HARDWARE COMPANY',
                    'HAWKER',
                    'HAWKER',
                    'HAWKERS',
                    ...
                    'HOSPITAL ATTENDANT',
                    'HOSPITAL CARE-TAKER',
                    'HOTEL & RESTAURANT CAPTAINS',
                    'HOTEL & RESTAURANT CHEFS',
                    'HOTEL & RESTAURANT WAITERS',
                    'HOUSE OFFICER',
                    'HOUSEKEEPING CLERK',
                    'HOUSEMAN',
                    ...
                    'IMMIGRATION OFFICER',
                    'IMPORTER & EXPORTER',
                    'INCENTIVE OPERATION ASSISTANT',
                    'INCOME ACCOUNTANT',
                    'INTERIOR DECORATORS',
                    'INWARD/OUTWARD EXECUTIVE',
                    'ISABELA OCCUPATION',
                    'ISLAND RESORT-GENERAL WORKERS',
                    'JANITOR',
                    'JOCKEY',
                    'JOURNALIST',
                    'JUDGE',
                    ...
                    'LINE LEADER',
                    'LUMBERJACK',
                    'LABEL PRESS PRINTING OPERATOR',
                    'LABOURER',
                    'LAND SURVEYOR',
                    'LAUNDRY-GENERAL WORKERS',
                    'LAUNDRYMEN',
                    'LAYOUT ARTIST',
                    'LEGAL ASSISTANT',
                    'LIFT ATTENDANT',
                    ...
                    'MAID',
                    'MAID/HOUSEKEEPER',
                    'MAINT HIGH FRQ EQUIP M/MACHINE',
                    'MAINTENANCE WORKER',
                    ...
                    'NURTURIST',
                    'NUTRITIONIST',
                    'NATIONAL SERVICES MAN',
                    'NOT AVAILABLE',
                    'OBSERVER',
                    'OCEANOGRAPHERS',
                    'OCEANOGRAPHIST',
                    'OFFICE APPLIANCES/STATIONERY',
                    'OFFICE BOY',
                    ...
                    'OTHERS SERVICES - GENERAL WORK',
                    'OUTBOUND OFFICER',
                    'OUTSTATION CASHIER',
                    'PACKER',
                    'PAINTER',
                    'PAPER & ITS RELATED PRODUCTS',
                    'PARA LEGAL',
                    'PASTOR',
                    'PATHOLOGIST',
                    'PAYMASTER',
                    ...
                    'RECEPTIONIST',
                    'RECEPTIONIST',
                    'REGISTERED ORGANISATIONS/FIRMS',
                    'REMISIER',
                    'RENTAL COMPANY',
                    'REPRESENTATIVE',
                    ...
                    'RESEARCHER',
                    'RESORT',
                    'RESTAURANT/CANTEEN/COFFEE SHOP',
                    'RETAIL OUTLET',
                    'RETAILER',
                    'RETIREE',
                    'RUBBER INDUSTRIES',
                    ...
                    'SENATE BEARER',
                    'SENATOR',
                    'SERVICE INDUSTRIES - OTHERS',
                    'SEWER',
                    'SHIPPING',
                    'SHIPREPAIRING/MARINE ENGINEER',
                    'SHOP ASSISTANCE',
                    'SINGER',
                    'SOLEPROPRIETOR',
                    'SOLICITOR',
                    ...
                    'SANITARY INSPECTOR',
                    'SCANNER ASSISTANT',
                    'SEA FREIGHT OPERATION ASST',
                    'SECURITY GUARD',
                    'SECURITY SERVICES-GENERAL WORK',
                    'SENIOR GLASS GLAZIER',
                    'SET-UP TECHNICIAN',
                    ...
                    'SIGNAL MAN',
                    'SIGNWRITER',
                    'SILK SCREEN AUTO MACHINE OP',
                    'SITE AGENT',
                    'SITE CLERK',
                    'SITE FOREMAN',
                    'SITE OPERATION TECHNOLOGIST',
                    'SKILLED PIPE FITTER',
                    'SOCIAL WORKER',
                    'SOFTWARE PROFESSIONAL',
                    'SPORT COMPLEX ASSISTANT',
                    'STALL HELPER',
                    'STEWARDING',
                    'STOCK CONTROLLER',
                    'STOCKBROKER',
                    'STOREMAN',
                    'STUDIO ASSISTANT',
                    'SUPERMART SALES ASSISTANT',
                    'SWIMMING POOL ATTENDANT',
                    'SYRUP PROCESS OPERATOR',
                    'SYSTEM ANALYST',
                    'TAILOR',
                    'TAILOR/ SEAMSTRESS',
                    'TEA LADY',
                    ...
                    'TRANSLATOR',
                    'TRANSPORTATION/COMM. - OTHERS',
                    'TRAVELLING/TICKETING AGENCY',
                    'TUTOR',
                    'TAX ASSISTANT',
                    'TAXI DRIVER',
                    ...
                    'TELEMARKETEER',
                    'TELEX OPERATOR',
                    'TICKETING/TOUR EXECUTIVE',
                    'TILER',
                    'TOOLSETTER',
                    'TOUR DRIVER',
                    'TRADENET CLERK',
                    'TRADERS',
                    'TRAFFIC & WAREHOUSE OFFICER',
                    'TRAFFIC POLICE',
                    'TRAIN DRIVER',
                    'TRANSHIPMENT EXPORT OFFICER',
                    'TRAVEL AGENCY',
                    'TREASURY ASSISTANT',
                    'TRICHOLOGIST',
                    'TYPIST',
