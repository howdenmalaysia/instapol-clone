                            ...
                            <tbody>
                                <tr>
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 25px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                        <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                            <p style="font-size: 14px; line-height: 140%;">
                                                A quick reminder! We understand that your car insurance will be expiring soon.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                                <tr>
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 10px 25px;font-family:arial,helvetica,sans-serif;" align="left">
                                        <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                            <p style="font-size: 14px; line-height: 140%;">Email Address</p>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 25px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                        <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                            <p style="font-size: 14px; line-height: 140%;">
                                                Click here <a href={{ $url }} target="__blank">https://motor-dev.instapol.my</a>, please key-in your default password which is the last four (4) digits of your Identity Card or Company Registered Number on the verification page to proceed next.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 25px;font-family:arial,helvetica,sans-serif;" align="left">
                                        ...
                                        <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                            <p style="font-size: 14px; line-height: 140%;">
                                                If you have any questions at all, we'd love to hear from you. You can get in touch by sending an email to <a href="mailto:instaPol@my.howdengroup.com">instaPol@my.howdengroup.com</a>.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
