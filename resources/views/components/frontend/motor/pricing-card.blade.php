    ...
    <table id="pricing-table" class="table table-borderless">
        ...
        <tbody>
            <tr>
                ...
                <td id="basic-premium" class="text-end">{{ $data->basic_premium }}</td>
            </tr>
            <tr>
                <td>
                ...
                <td class="text-end">RM</td>
                <td id="ncd" class="text-end">{{ $data->ncd_amount }}</td>
            </tr>
            <tr>
                <td>
                ...
                <td class="text-end">RM</td>
                <td id="add-ons-premium" class="text-end">{{ $data->total_benefit_amount }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-end">RM</td>
                <td id="gross-premium" class="text-end">{{ $data->gross_premium }}</td>
            </tr>
            <tr>
                <td>{{ '+ ' . __('frontend.price_card.service_tax') }}</td>
                <td class="text-end">RM</td>
                <td id="sst" class="text-end">{{ $data->sst_amount }}</td>
            </tr>
            <tr>
                <td>{{ '+ ' . __('frontend.price_card.stamp_duty') }}</td>
                <td class="text-end">RM</td>
                <td id="stamp-duty" class="text-end">{{ $data->stamp_duty }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td id="total-payable" class="fw-bold text-end">{{ $data->total_payable }}</td>
            </tr>
        </tbody>
    </table>
</div>