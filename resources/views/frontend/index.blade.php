                            ...
                            <div class="col-xl-11 col-12">
                                <div class="card px-3 text-center rounded">
                                    <div class="row">
                                        ...
                                        <div class="col d-flex align-items-center">
                                            <x-product url="" :image-path="asset('images/icons/extended-motor.png')" :alt="__('frontend.products.motor_extended')" :name="__('frontend.products.motor_extended')" />
                                        </div>
                                        <div class="col d-flex align-items-center">
                                            <x-product url="" :image-path="asset('images/icons/bicycle.png')" :alt="__('frontend.products.bicycle')" :name="__('frontend.products.bicycle')" />
                                        </div>
                                        <div class="col d-flex align-items-center">
                                            <x-product url="" :image-path="asset('images/icons/travel.png')" :alt="__('frontend.products.travel')" :name="__('frontend.products.travel')" />
                                        </div>
                                        <div class="col d-flex align-items-center">
                                            <x-product url="" :image-path="asset('images/icons/doc-pro.png')" :alt="__('frontend.products.doc_pro')" :name="__('frontend.products.doc_pro')" />
                                        </div>
