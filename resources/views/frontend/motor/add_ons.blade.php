                            ...
                            <div class="card-body">
                                ...
                                <div class="pb-4 px-md-3">
                                    @if (session('motor')->vehicle->min_sum_insured !== session('motor')->vehicle->max_sum_insured)
                                        ...
                                        <div id="sum-insured-tooltip" class="range" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="manual" title="{{ 'RM ' . number_format(session('motor')->vehicle->sum_insured) }}">
