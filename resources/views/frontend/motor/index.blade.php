                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        <div class="btn-group rounded" role="group">
                                                            ...
                                                            <label id="private-reg" class="{{ "btn text-uppercase" . !empty($motor->policy_holder->id_type) && $motor->policy_holder->id_type === config('setting.id_type.nric_no') ? "btn-primary text-white rounded-start border active" : "btn-light rounded-end" }}" for="id-type-1">{{ __('frontend.motor.private_registered') }}</label>
                                                            ...
                                                            <label id="company-reg" class="{{ "btn text-uppercase" . !empty($motor->policy_holder->id_type) && $motor->policy_holder->id_type === config('setting.id_type.company_registration_no') ? "btn-primary text-white rounded-start border active" : "btn-light rounded-end" }}" for="id-type-2">{{ __('frontend.motor.company_registered') }}</label>
                                                        </div>
                                                    </div>
                                                </div>
