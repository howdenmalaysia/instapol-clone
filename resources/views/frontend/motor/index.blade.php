                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        <div class="btn-group rounded" role="group">
                                                            ...
                                                            <label id="company-reg" class="{{ !empty($motor->policy_holder->id_type) && $motor->policy_holder->id_type === config('setting.id_type.company_registration_no') ? "btn btn-primary text-white rounded-start border active text-uppercase" : "btn btn-light rounded-end text-uppercase" }}" for="id-type-2">{{ __('frontend.motor.company_registered') }}</label>
                                                        </div>
                                                    </div>
                                                </div>
